...
int main( int argc, char *argv[] ) {
  ...
  gfw_pie_chart_add_segment( GTK_PIE_CHART(pie), 0.5, "First", rgba );
  rgba[0] = 0.5;
  gfw_pie_chart_add_segment( GTK_PIE_CHART(pie), 0.20, "Second", rgba );
  rgba[1] = 0.5;
  rgba[2] = 1.0;
  gfw_pie_chart_add_segment( GTK_PIE_CHART(pie), 0.10, "Third", rgba );
  rgba[1] = 0.3;
  rgba[2] = 0.9;
  /*rgba[3] = 0.5;*/
  gfw_pie_chart_add_segment( GTK_PIE_CHART(pie), 0.20, "Four", rgba );
